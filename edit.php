...
if (isset($_POST['update'])){
  ...
  if (empty($question && $option_A && $option_B && $option_C && $option_D) == false)
  {
    ...
    $sqlupdate = "UPDATE questions SET `course_title`='".$course_title."', `questions`='".$question."', `option_A`='".$option_A."', `option_B`='".$option_B."', `option_C`='".$option_C."', `option_D`='".$option_D."', `answer`='".$correct_answer."' WHERE `question_id`='".$question_id."' LIMIT 1";
          ...
          <div class="col-md-12">
            <div class="callaction bg-gray">
              <div class="row">
                <div class="col-md-8">
                    <div class="cta-text">
                      <h2>Welcome! Admin - <?php echo $fullname ; ?></h2>
